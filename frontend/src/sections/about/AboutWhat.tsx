              ...
              <Grid container spacing={3} alignItems='flex-end'>
                <Grid item xs={6}>
                  <m.div variants={varFade().inUp}>
                    <Image
                      alt='our office 1'
                      src='https://aesthesy.com/cdn/shop/files/custom_resized_758ec37b-c3c7-4e02-8c14-9d3a25e9d64d.jpg?v=1692844426&width=1100'
                      ratio='3/4'
                      sx={{
                        borderRadius: 2,
                        boxShadow: shadow,
                ...
                <Grid item xs={6}>
                  <m.div variants={varFade().inUp}>
                    <Image
                      alt='our office 2'
                      src='https://images.theconversation.com/files/296052/original/file-20191008-128681-ngzwqb.jpg?ixlib=rb-4.1.0&rect=15%2C20%2C929%2C926&q=20&auto=format&w=320&fit=clip&dpr=2&usm=12&cs=strip'
                      ratio='1/1'
                      sx={{ borderRadius: 2 }}
                    />
                  </m.div>

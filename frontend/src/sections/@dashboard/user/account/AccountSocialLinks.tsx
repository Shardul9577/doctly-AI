...
export default function AccountSocialLinks({ myProfile }: Props) {
  ...
  const methods = useForm<FormValuesProps>({
    ...
    mode: 'onChange', // 🟢 Important for tracking changes
  });
  ...
  // ✅ Fetch from server on mount to stay up-to-date
  ...
  const onSubmit = async (data: FormValuesProps) => {
    try {
      ...
      const res = await axiosInstance.put('/api/doctors/profile', payload);
      enqueueSnackbar(

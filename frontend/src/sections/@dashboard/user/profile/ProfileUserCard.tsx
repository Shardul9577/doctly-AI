...
const ProfileButton = styled(Button)(({ theme }) => ({
  ...
  '&:hover': {
    ...
    // also make sure icons or nested text inherit the color
  ...
  return (
    ...
    >
        ...
        >
          <Tooltip title='Age' arrow>
            <ProfileButton
              ...
              sx={{ flex: '0 0 auto', minWidth: 110 }} // prevent shrink
            >
              {profile?.personal_info?.age || 'N/A'} years
            </ProfileButton>
          </Tooltip>
          ...
          <Tooltip title='License Number' arrow>
            ...
            >
              {profile?.qualification_info?.license_number || 'N/A'}
            </ProfileButton>
          </Tooltip>
          ...
          <Tooltip title='Medical School' arrow>
            <ProfileButton
              ...
              sx={{ flex: '0 0 auto', minWidth: 150 }}
            >
              {profile?.qualification_info?.medical_school || 'N/A'}
            </ProfileButton>
          </Tooltip>
        </Stack>
      </Box>
      ...
      >
        ...
        {profile?.qualification_info?.languages ? (
      ...
      <Stack direction='row' alignItems='center' spacing={1}>
        ...
        <Chip
          label={profile?.qualification_info?.qualification || 'None'}
          size='small'
          sx={{

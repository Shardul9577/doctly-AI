      ...
      >
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={4}>
            ...
            <InfoValue>
              {profile?.organization_info?.organization_name || 'Not provided'}
            </InfoValue>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            <InfoValue>
              {profile?.organization_info?.organization_id || 'Not provided'}
            </InfoValue>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <InfoLabel>Email Address</InfoLabel>
            <InfoValue>
              {profile?.organization_info?.organization_email || 'Not provided'}
            </InfoValue>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            <InfoValue>
              {profile?.organization_info?.organization_people?.length ||
                'Not provided'}
            </InfoValue>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            <InfoValue>
              {profile?.organization_info?.organization_type || 'Not provided'}
            </InfoValue>
          </Grid>

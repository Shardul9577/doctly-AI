...
export default function UserProfile() {
  ...
  const fetchAdminAbout = async () => {
    try {
      const response = await axiosInstance.get('/api/admin/account/my-account');
      
      setUserAbout(response?.data?.aboutDetails);
     
    } catch (error) {
      console.error('Failed to fetch Admin about info:', error);
    }
  };
  ...
  const PROFILE_TABS = [
    {
      ...
      component: <Profile myProfile={userAbout} posts={_userFeeds} />,
    },
    // {
    //   value: 'followers',

...
import {
  ProductTableRow,
  ProductTableToolbar,
} from '../../../sections/@admin/e-commerce/product-list';
...
export default function EcommerceProductList() {
  ...
  const handleEditRow = (id: string) => {
    push(PATH_ADMIN_DASHBOARD.eCommerce.edit(paramCase(id)));
  };
    ...
    <Page title="Ecommerce: Product List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          action={
            <NextLink href={PATH_ADMIN_DASHBOARD.eCommerce.new} passHref>

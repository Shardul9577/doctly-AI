...
// sections
import InvoiceAnalytic from '../../../sections/@admin/invoice/InvoiceAnalytic';
import { InvoiceTableRow, InvoiceTableToolbar } from '../../../sections/@admin/invoice/list';
...
export default function InvoiceList() {
  ...
  const [tableData, setTableData] = useState<any[]>(_invoices as any[]);
  ...
  const handleEditRow = (id: string) => {
    push(PATH_ADMIN_DASHBOARD.invoice.edit(id));
  };

  const handleViewRow = (id: string) => {
    push(PATH_ADMIN_DASHBOARD.invoice.view(id));
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Invoices', href: PATH_ADMIN_DASHBOARD.invoice.root },
            { name: 'List' },
          ]}
          action={
            <NextLink href={PATH_ADMIN_DASHBOARD.invoice.new} passHref>

...
} from '../../sections/@admin/general/e-commerce';
import { AppWelcome } from '../../sections/@admin/general/app';
// assets
    ...
    <Page title='General: E-commerce'>
      <Container maxWidth={themeStretch ? false : 'xl'}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={12}>
            <EcommerceBestSalesman
              title='Top 10 doctors in terms of purchase !'
          ...
          <Grid item xs={12} md={4}>
            <EcommerceWidgetSummary
              title='Total Profit by Insurance Companies !'
              percent={-0.1}
              total={18765}
              chartColor={theme.palette.chart.green[0]}
              chartData={[56, 47, 40, 62, 73, 30, 23, 54, 67, 68]}
          ...
          <Grid item xs={12} md={4}>
            <EcommerceWidgetSummary
              title='Total Profit by Hospitals !'
              percent={0.6}
              total={4876}
              chartColor={theme.palette.chart.red[0]}
              chartData={[40, 70, 75, 70, 50, 28, 7, 64, 38, 27]}

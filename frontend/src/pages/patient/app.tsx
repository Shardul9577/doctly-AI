...
import { AnalyticsNewsUpdate } from '../../sections/@patient/general/analytics';
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={8}>
            <AppWelcome
              ...
              description='Where your story and journey truly come alive!'
              img={
                <SeoIllustration
                  sx={{
                    p: 3,
          ...
          {/* graph should have x axis as day and y axis as intensity of that disease in percentage */}
          <Grid item xs={12} md={12}>
            <AppAreaInstalled
              title='Doctor Visits Graph'
          ...
          <Grid item xs={12} md={12}>
            <AnalyticsNewsUpdate
              title='Your Current Heath Update !'
              list={_analyticPost}
            />
          </Grid>
          ...
          <Grid item xs={12} md={12}>
            <Stack spacing={3}>
              <AppWidget title="Total Reports" total={38566} icon={'eva:person-fill'} chartData={48} />
              <AppWidget
                title="Applications"
                total={55566}
                icon={'eva:email-fill'}
